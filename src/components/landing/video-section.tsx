    ...
    >
      ...
      <div className="mx-auto mt-10 max-w-content">
        {src ? (
          ...
          // aparência técnica de placeholder (nada de borda tracejada):
          // um gradiente e um selo de marca sutil, como se já fosse parte
          // do design final, não um espaço vazio a preencher depois.
          <div className="relative flex aspect-video w-full flex-col items-center justify-center gap-4 overflow-hidden rounded-lg bg-[radial-gradient(120%_140%_at_50%_0%,_var(--color-brand-primary)_0%,_var(--color-brand-primary-deep)_55%,_#0a2544_100%)] px-6 text-center shadow-lg">
            <div
              aria-hidden="true"
