...
export const MOCK_CASES: PortalCase[] = [
  {
    ...
    nextAction: {
      ...
      href: "/portal-curador/casos/caso-2041/consulta",
      kind: "acao",
    },
    pendencies: [
      {
  ...
  },
  {
    ...
    nextAction: {
      ...
      href: "/portal-curador/casos/caso-2038/curadoria",
      kind: "acao",
    },
    pendencies: [],
    alerts: [],
  ...
  },
  {
    ...
    nextAction: {
      ...
      href: "/portal-curador/casos/caso-2033/relatorio",
      kind: "acao",
    },
    pendencies: [],
    alerts: [
  ...
  },
  {
    ...
    nextAction: {
      ...
      href: "/portal-curador/casos/caso-2029/curadoria",
      kind: "acao",
    },
    pendencies: [],
    alerts: [
  ...
  },
  {
    ...
    nextAction: {
      ...
      href: "/portal-curador/casos/caso-2024/entrega",
      kind: "aguardando",
    },
    pendencies: [
      {
  ...
  },
  {
    ...
    nextAction: {
      ...
      href: "/portal-curador/casos/caso-2019/consulta",
      kind: "acao",
    },
    pendencies: [],
    alerts: [],
