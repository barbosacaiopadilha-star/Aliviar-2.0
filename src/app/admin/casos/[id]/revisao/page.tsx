...
type AdminHumanReviewPageProps = {
  params: Promise<{ id: string }>;
};

export default async function AdminHumanReviewPage({ params }: AdminHumanReviewPageProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <Link href={`/admin/casos/${id}`} className="text-sm text-brand-primary hover:text-brand-primary-deep">
          ← Voltar para o Caso
        </Link>
