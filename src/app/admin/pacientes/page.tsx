  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="font-sans text-2xl font-semibold text-ink">Pacientes</h1>
          <p className="text-sm text-ink-muted">
            A equipe Aliviar realiza o cadastro inicial — não existe cadastro público de paciente.
          </p>
        </div>
        <Link
