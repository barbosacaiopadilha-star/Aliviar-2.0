...
describe("crm audit security (migration contract)", () => {
  const auditMigration = readFileSync(
    resolve(process.cwd(), "supabase/migrations/20260724055744_crm_audit_secure_function.sql"),
    "utf8",
  );
  const foundationMigration = readFileSync(
    resolve(process.cwd(), "supabase/migrations/20260724054932_crm_operational_foundation_rls.sql"),
    "utf8",
  );
