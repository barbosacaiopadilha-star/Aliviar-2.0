...
- **Data:** 2026-08-20
- **Status:** **Decisão de mérito tomada pelo Fundador**, em conversa direta, nesta data. **Dois pontos seguem em aberto e bloqueiam a implementação** — retenção de quem não contrata (§Aberto 1) e como a história reencontra a pessoa (§Aberto 2). Nada foi implementado.
...
- **Aberto 1 — retenção de quem não contrata (decisão do Fundador, com o advogado):** o relato é dado sensível de saúde de alguém que não é cliente. Três caminhos foram apresentados: **(a)** apagar após prazo explícito (ex.: 90 dias), dito na própria tela no momento em que ela escreve — recomendado por quem escreve esta ADR, por ser o que mais respeita quem se abriu; **(b)** guardar até ela pedir exclusão — mais responsabilidade, e a que mais pesa numa fiscalização; **(c)** guardar só o não-sensível e descartar o texto livre — perde a riqueza do relato. **Sem esta decisão a implementação não começa**, porque ela determina o que a tela promete à pessoa enquanto escreve.
- **Aberto 2 — como a história reencontra a pessoa:** escrevendo anônima e voltando semanas depois pelo WhatsApp, algo precisa ligar as duas pontas — telefone ou e-mail. Isto decide o que o formulário público pede **além** do relato, e portanto o desenho da tela.
...
- **Consequência:** pela primeira vez o produto guarda relato de saúde de quem ainda não é paciente. É mudança de natureza, não de grau — e é por isso que §Aberto 1 não é detalhe de implementação, e sim parte da decisão.
