...
| 16k | [`CONTRATO_2_3_DIVISAO_DA_AVALIACAO.md`](CONTRATO_2_3_DIVISAO_DA_AVALIACAO.md) | Derivado | **PROPOSTA (2026-08-08) — aguarda julgamento do Guardião** | Item 2.3: divisão da AVALIAÇÃO (ADR-067 §5) — 3 lado-da-pessoa ao Motor; H8–H11 ao Curador com destino único `curator_judgments` · duas capabilities gate-first (`registrar_julgamento`/`retirar_julgamento`), autoria por sessão · desfechos herdados do PA-15 · **trigger JS3** (evidência nova supersede; zero carry-forward) · campo de conclusão nasce vazio · árbitro é o banco do 2.4 · flag restaura 6×N · G-2.3-1..8 |
