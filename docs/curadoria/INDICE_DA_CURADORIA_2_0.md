...
| 16i | [`CONTRATO_2_6_RELEITURA_DE_ESCOPO.md`](CONTRATO_2_6_RELEITURA_DE_ESCOPO.md) | Derivado | **PROPOSTA (2026-08-08) — aguarda aprovação do Guardião** | Releitura do 2.6: ampliação de escrita SUPERADA (ADR-068 §14.2) · ato autor/data/visível SATISFEITO pelo 1.12 · residual = guardas do recorte + I-12 + §13.2 herdado pelo 2.C + **G-10/Item 1.2** (opções A×B×C; recomendação **B**: capability `nome_do_curador_do_caso` com gate `is_patient_for_case`) |
