...
### Guardas do Item 2.C — **APROVADAS, PENDENTES DE IMPLEMENTAÇÃO** (PA-17, 2026-08-08)

Lavradas no [`CONTRATO_2_C_FRONTEIRA_DO_MAPA_DO_PROFISSIONAL.md`](CONTRATO_2_C_FRONTEIRA_DO_MAPA_DO_PROFISSIONAL.md)
§14–§15; **nenhuma está implementada** — entram com o pacote de implementação/abertura.
