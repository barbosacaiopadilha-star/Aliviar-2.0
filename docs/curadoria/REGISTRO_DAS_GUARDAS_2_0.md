...
| Guarda | Objetivo | Princípio | Arquivos | Como falha | Como é detectada |
|---|---|---|---|---|---|
| **C-01** Nenhuma proposta persistida | `derivation_proposals` não nasce antes da ADR-A e das dez dependências | P-08; Arquitetura §15.0 | `src/**` · `supabase/migrations/**` | a tabela, o módulo ou um estado `PROPOSTA` aparece | varredura do repositório |
