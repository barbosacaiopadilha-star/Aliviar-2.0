...
| **1.12** | Mecanismo de discordância na Fronteira Humana | Discordar custar o mesmo que concordar | 1.11 ✅ · [`CONTRATO_1_12_MECANISMO_DE_DISCORDANCIA.md`](CONTRATO_1_12_MECANISMO_DE_DISCORDANCIA.md) | O2 verde (P-10 como contrato testado) — desdobrado em O2-A..E pelo Contrato §20/§25 | **CONTRATO EM PROPOSTA** (2026-08-08) — **aguarda aprovação da autoridade de governança**; implementação **não autorizada** | Implementador | remover — tudo aditivo, zero ato real nesta onda (Contrato §24) | **novo** |
