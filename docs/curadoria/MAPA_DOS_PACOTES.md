...
| **2.3** | Divisão da etapa AVALIAÇÃO | 3 critérios do lado da pessoa passam a vir do Motor | **ADR-067** (ex-"ADR-B") · 1.4 ✓ · **2.4 (dependência MATERIAL — os juízos H8–H11 têm `curator_judgments` como destino; CONTRATO_2_4 §18)** | X1 verde; FORMACAO/EXPERIENCIA/HISTORICO permanecem humanos | **ELEGÍVEL — APTO A RECEBER PRÉ-VOO/CONTRATO** (2026-08-08) — a dependência material foi integralmente satisfeita: 2.4 implementado (`2f6ec05`), verificado e **formalmente encerrado**; `curator_judgments` existe como destino dos juízos H8–H11. Implementação segue exigindo contrato próprio lavrado, conforme o processo vigente | Implementador | flag restaura 6×N | L-40 + L-41 |
