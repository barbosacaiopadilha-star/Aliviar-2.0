...
| **1.8-R1** | **Fechamento da Proveniência da Ficha** | Cumprir integralmente o §11.4 | 1.8 · 1.9 · [`CONTRATO_1_8_R1.md`](CONTRATO_1_8_R1.md) | os **doze** critérios do §16 do Contrato | **EM EXECUÇÃO** — checkpoint em `5afe937` + migration do vínculo aplicada e conferida (não rastreada); **C-01 emendada em 2026-08-07** (§18 do Contrato), o pacote está **desbloqueado**; restante não iniciado | Implementador | reverter ao estado de `c3242ea`; a migration é aditiva e reversível | **novo** |
