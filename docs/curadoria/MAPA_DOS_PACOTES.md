...
| **1.11** | Painel de discordância, vazio | Existir antes da primeira regra | 1.8 ✅ · [`CONTRATO_1_11_PAINEL_DE_DISCORDANCIA.md`](CONTRATO_1_11_PAINEL_DE_DISCORDANCIA.md) | O6: taxa de discordância observável por conceito e por versão · os **dez** critérios do §16 do Contrato | **PRONTO PARA AUTORIZAÇÃO PELO DT-01** — leitor agregado lavrado em 2026-08-07; **não autorizado, não iniciado** | Implementador | remover painel + `drop` da capability | **novo** |
