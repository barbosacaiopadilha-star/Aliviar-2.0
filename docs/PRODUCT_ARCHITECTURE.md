...
5. Sua decisão gera o `HumanReviewResult` — e, se validada, dispara a entrega (P010) automaticamente ou sob confirmação (decisão de produto a definir na próxima sprint de implementação).
