...
| 4   | Connection & Relationship Engine   | Connection: **Implementado** (`docs/DECISIONS.md` ADR-027, promovido 2026-07-15 após auditoria de integração contra banco real — até então, Conceitual/Fase 0, depois Implementação em Auditoria; histórico preservado no documento de domínio). Relationship: **Implementação em Auditoria** (`docs/DECISIONS.md` ADR-028, 2026-07-15 — divergência crítica contra a teoria aprovada corrigida antes do primeiro commit; seis capacidades previstas ainda ausentes, ver ADR-028). | [`DOMAIN_CONNECTION_RELATIONSHIP.md`](./DOMAIN_CONNECTION_RELATIONSHIP.md)       |
